...
('jdoe', HASHBYTES('SHA2_256', 'wachtwoord'), 'John', 'Doe', 'Client'),
('mvermeer', HASHBYTES('SHA2_256', 'wachtwoord'), 'Maria', 'Vermeer', 'Client'),
('rdeboer', HASHBYTES('SHA2_256', 'wachtwoord'), 'Rik', 'de Boer', 'Personnel'),
('sbakker', HASHBYTES('SHA2_256', 'wachtwoord'), 'Sophie', 'Bakker', 'Personnel'),
('fholwerda', HASHBYTES('SHA2_256', 'wachtwoord'), 'Fenna', 'Holwerda', 'Client'),
('kdijkstra', HASHBYTES('SHA2_256', 'wachtwoord'), 'Klaas', 'Dijkstra', 'Client'),
('lheineken', HASHBYTES('SHA2_256', 'wachtwoord'), 'Lucas', 'Heineken', 'Personnel'),
('mvandam', HASHBYTES('SHA2_256', 'wachtwoord'), 'Mila', 'van Dam', 'Personnel'),
('gkoolstra', HASHBYTES('SHA2_256', 'wachtwoord'), 'Gert', 'Koolstra', 'Client'),
('evisscher', HASHBYTES('SHA2_256', 'wachtwoord'), 'Emma', 'Visscher', 'Client'),
('tjanssen', HASHBYTES('SHA2_256', 'wachtwoord'), 'Tom', 'Janssen', 'Personnel'),
('abrouwer', HASHBYTES('SHA2_256', 'wachtwoord'), 'Anna', 'Brouwer', 'Personnel'),
('wbos', HASHBYTES('SHA2_256', 'wachtwoord'), 'Willem', 'Bos', 'Client'),
('tvandermeer', HASHBYTES('SHA2_256', 'wachtwoord'), 'Tessa', 'van der Meer', 'Client'),
('rkramer', HASHBYTES('SHA2_256', 'wachtwoord'), 'Rob', 'Kramer', 'Personnel'),
('mnijland', HASHBYTES('SHA2_256', 'wachtwoord'), 'Maud', 'Nijland', 'Personnel'),
('dschouten', HASHBYTES('SHA2_256', 'wachtwoord'), 'David', 'Schouten', 'Client'),
('hdeleeuw', HASHBYTES('SHA2_256', 'wachtwoord'), 'Hanna', 'de Leeuw', 'Client'),
('pvanveen', HASHBYTES('SHA2_256', 'wachtwoord'), 'Peter', 'van Veen', 'Personnel'),
('adekhane', HASHBYTES('SHA2_256', 'wachtwoord'), 'Ahmed', 'Dekhane', 'Client'), 
('mbouaziz', HASHBYTES('SHA2_256', 'wachtwoord'), 'Mouna', 'Bouaziz', 'Client'), 
('tbayrak', HASHBYTES('SHA2_256', 'wachtwoord'), 'Tarik', 'Bayrak', 'Personnel'), 
('ayildiz', HASHBYTES('SHA2_256', 'wachtwoord'), 'Aylin', 'Yildiz', 'Personnel'), 
('rnarsingh', HASHBYTES('SHA2_256', 'wachtwoord'), 'Rajesh', 'Narsingh', 'Client'), 
('sdurga', HASHBYTES('SHA2_256', 'wachtwoord'), 'Shanti', 'Durga', 'Client'), 
('mkassem', HASHBYTES('SHA2_256', 'wachtwoord'), 'Mohammed', 'Kassem', 'Personnel'), 
('lsaleh', HASHBYTES('SHA2_256', 'wachtwoord'), 'Lina', 'Saleh', 'Personnel'), 
('aghebre', HASHBYTES('SHA2_256', 'wachtwoord'), 'Amanuel', 'Ghebre', 'Client'), 
('mtsega', HASHBYTES('SHA2_256', 'wachtwoord'), 'Miriam', 'Tsega', 'Client'), 
('pkowalski', HASHBYTES('SHA2_256', 'wachtwoord'), 'Piotr', 'Kowalski', 'Personnel'), 
('aivanov', HASHBYTES('SHA2_256', 'wachtwoord'), 'Alexei', 'Ivanov', 'Personnel'), 
('mkarimi', HASHBYTES('SHA2_256', 'wachtwoord'), 'Mina', 'Karimi', 'Client'), 
('hradman', HASHBYTES('SHA2_256', 'wachtwoord'), 'Hassan', 'Radman', 'Client'), 
('lbaloyi', HASHBYTES('SHA2_256', 'wachtwoord'), 'Lerato', 'Baloyi', 'Personnel'), 
('dpetrov', HASHBYTES('SHA2_256', 'wachtwoord'), 'Dmitri', 'Petrov', 'Personnel'), 
('ibrahimovic', HASHBYTES('SHA2_256', 'wachtwoord'), 'Ismail', 'Brahimovic', 'Client'), 
('snovak', HASHBYTES('SHA2_256', 'wachtwoord'), 'Sanja', 'Novak', 'Client'), 
('yabebe', HASHBYTES('SHA2_256', 'wachtwoord'), 'Yonas', 'Abebe', 'Personnel'), 
('ngebre', HASHBYTES('SHA2_256', 'wachtwoord'), 'Nardos', 'Gebre', 'Personnel'); 
